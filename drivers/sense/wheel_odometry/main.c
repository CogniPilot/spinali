...
LOG_MODULE_REGISTER(sense_wheel_odometry, CONFIG_SPINALI_SENSE_WHEEL_ODOMETRY_LOG_LEVEL);
...
static context_t g_ctx = {.work_item = Z_WORK_INITIALIZER(wheel_odometry_work_handler),
			  .device = {},
			  .node = {},
			  .pub = {},
			  .data = {
...
K_THREAD_DEFINE(sense_wheel_odometry, MY_STACK_SIZE, sense_wheel_odometry_entry_point, &g_ctx, NULL,
		NULL, MY_PRIORITY, 0, 100);
