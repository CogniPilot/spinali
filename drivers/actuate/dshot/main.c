...
#define DT_DRV_COMPAT spinali_dshot_actuators
...
LOG_MODULE_REGISTER(actuate_dshot, CONFIG_SPINALI_ACTUATE_DSHOT_LOG_LEVEL);
...
#define DSHOT_ACTUATORS_DEFINE(inst)                                                               \
	static const actuator_dshot_t g_actuator_dshots_##inst[] = {                               \
		DT_FOREACH_CHILD(DT_INST(inst, spinali_dshot_actuators), DSHOT_ACTUATOR_DEFINE)};  \
	...
	static struct context data_##inst = {                                                      \
		...
		.num_actuators = DT_CHILD_NUM(DT_INST(inst, spinali_dshot_actuators)),             \
	};                                                                                         \
